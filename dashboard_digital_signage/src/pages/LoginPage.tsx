export const LoginPage = () =>{
  return (
    <section className="w-full h-screen bg-gray-100 flex flx-col justify-center items-center">
      <form className="w-full max-w-sm lg:max-w-md mx-auto bg-white flex flex-col shadow-xl p-8">
        ...
        <button className=" py-2 px-4 bg-red-600 text-white max-w-24 self-end mt-8">
          Acceder
        </button>
      </form>
